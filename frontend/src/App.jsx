...
//     try {
//       return JSON.parse(
//         localStorage.getItem("sahayak-current-user")
//       ) || null;
//     } catch {
//       return null;
//     }
...
//     if (!currentUser) {
//       return "sahayak-history-guest";
//     }

//     return `sahayak-history-${currentUser.email}`;
//   };
...
//     const users =
//       JSON.parse(
//         localStorage.getItem("sahayak-users")
//       ) || [];
...
//         title:
//           currentQuery.length > 45
//             ? currentQuery.substring(0, 45) + "..."
//             : currentQuery,
...
//       setAnswer(
//         "⚠️ Could not connect to the Sahayak backend. Please make sure FastAPI is running on http://localhost:8000."
//       );
...
//                   : handleSignup
//               }
//               className="mt-6 w-full rounded-xl bg-emerald-700 px-4 py-3 font-semibold text-white shadow-md transition hover:bg-emerald-800"
//             >
...
const handleLogin = async (e) => {
  ...
  const handleSignup = async () => {
     ...
     * IMPORTANT:
     *
     * Your currently tested backend endpoints did not
     * include a signup endpoint.
     *
     * Therefore we don't call a guessed endpoint here.
     */

    setAuthError(
      "Account creation must be connected to your backend registration endpoint. Please use an existing backend account to log in."
    );
